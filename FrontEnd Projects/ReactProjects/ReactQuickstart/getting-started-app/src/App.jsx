...
function MyButtonTwo() {
    ...
    return (
        <>
            <p>
                click on the below button to see the alert box functionality
                work
            </p>
    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                <MyButtonTwo />
                <p>
                    click on the below button to see a count of how many number
                    of times you have clicked onthe button
                </p>
                <MyButtonThree />
            </header>
        </div>
